...
import { X, Sparkles, Send, AlertCircle, CheckCircle, User, Mail, Phone, Building, MessageSquare } from "lucide-react";
...
export default function PopupContactForm() {
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-md p-0 overflow-hidden border-none bg-transparent shadow-xl">
        <AnimatePresence>
          {open && (
            <motion.div
            ...
            >
              ...
              {/* Content container */}
              <div className="relative z-10 w-full bg-white/90 dark:bg-gray-900/80 backdrop-blur-md shadow-lg rounded-xl overflow-hidden border border-white/20">
                {/* Header section */}
                <div className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 p-4 rounded-t-xl">
                ...
                <div className="p-4">
                  {submitted ? (
                    ...
                    <form onSubmit={handleSubmit} className="space-y-3">
                      ...
                      {/* Two columns for phone and company */}
